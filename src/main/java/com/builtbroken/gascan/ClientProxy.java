...
import com.builtbroken.gascan.content.BucketMaterialCanClient;
...
public class ClientProxy extends CommonProxy
{
    ...
    public void init()
    {
        GasCanMod.gasCanBucketMaterial = new BucketMaterialCanClient("sbmgascan:gascan", "sbmgascan:gascan");
